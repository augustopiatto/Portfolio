  ...
  return (
    ...
    >
      <div
        ...
        ref={dialogRef}
        className="relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-card w-2/3 rounded-dialog max-h-[90%] overflow-auto pt-24 pb-10 px-10 medium:px-20"
      >
